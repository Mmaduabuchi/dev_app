                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        $stmt = $conn->prepare("SELECT id, title, created_at FROM notifications WHERE user_id = ? AND deleted_at IS NULL ORDER BY created_at DESC");
                                        $stmt->bind_param("i", $user_id);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        ...
                                        <?php
                                            ...
                                            echo "<p class='bg-light rounded p-3 mb-2 mb-0'>No requests yet.</p>";
                                        }
