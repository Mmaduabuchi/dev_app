                    ...
                    <div class="row">
                        <div class="col">
                            <div class="alert alert-secondary" role="alert">
                                <div class="row">
                                    <div class="col pt-3">
                                        <h5>10X your sales with robust features on Selar Pro!</h5>
                                    </div>
                                    <div class="col-12 col-md-6 text-end">
                                        <button class="btn btn-primary  p-3 w-50"> Upgrade your account</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 mt-4">       
                        <div class="col">                 
                            <div class="alert" role="alert">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="text-dark">Creator Dashboard</h4>
                                    </div>
                                    <div class="col d-none d-md-block text-end">
                                        <button class="btn btn-primary p-3 w-50"> <i class="mdi mdi-plus"></i> Add a product</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="widget-first">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <p class="mb-0 text-dark fs-15">Task Sales</p>
                                        </div>
