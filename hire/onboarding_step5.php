    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <p class="step-title"> <i class="bi bi-arrow-left-circle icon"></i> STEP 5</p>
                <h3 class="main-question">What level of time commitment will you require from the developer?</h3>

                <!-- Option 1 -->
                <div class="option-card">
                    <div class="d-flex align-items-center">
                        <div class="option-text">
                            <h6>Full time (40 or more hours/week)</h6>
                        </div>
                    </div>
                ...
                <div class="option-card">
                    <div class="d-flex align-items-center">
                        <div class="option-text">
                            <h6>Part time (Less than 40 hours/week)</h6>
                        </div>
                    </div>
                    <div class="arrow-icon">→</div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            optionCards.forEach(card => {
                card.addEventListener('click', () => {
                    ...
                    // Send to backend
                    fetch('<?php echo $base_url; ?>process/process_save_onboarding5.php', {
                        method: 'POST',
                        headers: {
