...
<head>
        ...
        <meta charset="utf-8" />
        <title>Logout | Hando - Dashboard </title>
        ...
        <script src="../app/assets/js/head.js"></script>
                                        ...
                                        <div class="mb-0 p-0 p-lg-3">
                                            <div class="mb-0 border-0 p-md-4 p-lg-0">
                                                <div class="mb-4 p-0 text-center">
                                                    <div class="auth-brand">
                                                        <a class='logo logo-light' href='index.html'>
                                                            <span class="logo-lg">
                                                                <img src="../app/assets/images/logo-light-3.png" alt="" height="24">
                                                            </span>
                                                        </a>
                                                        <a class='logo logo-dark' href='index.html'>
                                                            <span class="logo-lg">
                                                                <img src="../app/assets/images/logo-dark-3.png" alt="" height="24">
                                                            </span>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="text-center">
                                                    <a class='btn btn-primary mt-3 me-1' href='auth-login.html'> Log In </a>
                                                </div>
            
                                                <div class="maintenance-img text-center pt-4">
                                                    <img src="../app/assets/images/svg/logout.svg" height="200" alt="svg-logo">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
